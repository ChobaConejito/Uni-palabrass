player1_name = localStorage.getItem("player1_name");//asignamos a la variable lo que esta en la memoria local
	player2_name = localStorage.getItem("player2_name");//Hola ! En este caso asignamos el nombre de los jugadores :)
